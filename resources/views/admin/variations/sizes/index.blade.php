...
@section('admin')
    ...
    <form method="post" action="{{route('admin.variations.size.store')}}" class="mt-4">
        @csrf
        <div class="d-flex align-items-center justify-content-center py-2">
            <input name="size" type="text" class="input-group-text bg-dark text-light me-3 shadow" placeholder="عنوان سایز...." style="width: 300px ; border: none ; outline: none">
        </div>
        @error('size') <div class="text-danger text-center" style="font-size: 13px">عنوان  سایز نباید تکراری باشد</div> @enderror
