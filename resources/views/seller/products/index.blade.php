...
.addProductBox{{$key}}{
    ...
    <div class="-100">
        ...
        <a href="{{route('seller.products.create')}}" class="text-center  opacity-75 text-success d-inline-block align-items-center justify-content-start px-3 h5" style="text-decoration: none">
    ...
    <script>
        ...
        function defeult(a , b , c , s){
            ...
            for (i = 0 ; i < newArray.length ; i++){
                ...
                addElementVarietyToDiv.innerHTML = '<a  href="' + `${baseURL}` + '/seller/request/image-' + newArray[i].id + '"  style="text-decoration: none"> <i title="درخواست افزودن عکس" class="bi-images h5 text-light opacity-50 p-1 addPic" style="cursor: pointer"></i></a> <a href="' + `${baseURL}` + '/seller/products/addVar-' + `${newArray[i].id}` + '"  style="text-decoration: none" > <i title="افزودن تنوع" class="bi-stack h4 text-light opacity-50 p-1 addVar" style="cursor: pointer"></i></a> ';
