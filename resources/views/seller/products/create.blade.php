...
<form  class="d-flex align-items-center justify-content-around flex-column position-relative" method="post" action="{{route('seller.products.store')}}" enctype="multipart/form-data">
    @csrf
    @method('post')
    ...
    <div class="row w-100 d-flex border-bottom border-dark py-3">
        ...
        <div class="col-12 col-md-7 d-flex flex-column position-relative">
            ...
            <a  class="text-info py-1 opacity-50" data-bs-toggle="modal" data-bs-target="#exampleModal" style="text-decoration: none ; font-size: 12px"> درخواست ایجاد گروه </a>
        ...
        <div class="col-12 col-md-3 d-flex flex-column position-relative">
            ...
            <a data-bs-toggle="modal" data-bs-target="#exampleModalBrand" class="text-info py-1 opacity-50" style="text-decoration: none ; font-size: 12px"> درخواست ایجاد برند </a>
        </div>
    ...
    <div class="row py-3 w-100 d-flex align-items-center justify-content-around border-bottom border-dark">
        ...
        <div class="col-12 col-md-6 d-flex align-items-center justify-content-center py-3 px-3">
            <div class="row d-flex align-items-center w-100">
                ...
                <div class="col-1 mt-0 position-relative" style="font-size: 14px ; top: -30px">
                </div>
            </div>
        ...
        <div class="modal-dialog" style="margin-top: 100px">
            <div class="modal-content  position-relative" style="height: 200px ; background-color: #3a3a3a">
                ...
                <div class="modal-body mt-5">
                    <form class="" method="post" action="{{route('seller.request.category')}}">
                        @csrf
                        <input name="category" type="text" class="input-group-text bg-dark w-100 text-light shadow" placeholder="عنوان گروه...." style="border: none ; outline: none" >
    ...
    <div class="modal fade" id="exampleModalBrand" tabindex="-1" aria-labelledby="exampleModalLabelBrand" aria-hidden="true">
        <div class="modal-dialog" style="margin-top: 100px">
            <div class="modal-content  position-relative" style="background-color: #3a3a3a">

                <div class="modal-body mt-5">
                    <form class="" method="post" action="{{route('seller.request.brand')}}" enctype="multipart/form-data">
                        @csrf
                        <input name="brand" type="text" class="input-group-text bg-dark w-100 text-light shadow" placeholder="عنوان برند...." style="border: none ; outline: none" >
                        <input name="logo" type="file" class=" w-100 text-light py-4" style="border: none ; outline: none" >
                        <textarea name="about" type="text" class="bg-dark w-100 text-light p-2 rounded-3" style="border: none ; outline: none" ></textarea>
                        <button type="submit" class="btn btn-success m-auto d-block mt-5">ارسال</button>
                    </form>
                </div>
                <button type="button" class="btn text-light bi-x-lg position-absolute" data-bs-dismiss="modal" style="left: 5px ; top: 5px"></button>
