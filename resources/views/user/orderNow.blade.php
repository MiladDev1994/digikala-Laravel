...
@section('center')
    ...
    <div class="user-box-left-too-downBox w-100 border mt-2 py-3">
        ...
        <div class="h5 px-3  py-3 d-inline-block" style="font-weight: 600">سفارشات جاری</div>
        @foreach($orders as $order)
            <div class="w-100 border-top d-flex align-items-center justify-content-between" >
                ...
                <div class="w-100 h-100 py-2 position-relative">
                    <a href="{{route('user.panel.order.cancel' , $order->id)}}" class="position-absolute" style="text-decoration: none ; left: 10px ; top: 10px"><i class="bi-x-lg h4 text-dark"></i></a>
